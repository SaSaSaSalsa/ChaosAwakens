...
public class Enchanted_Cow extends Red_Cow
     {
       public Enchanted_Cow(World world) {
       super(world);
       }
       ...
       public Enchanted_Cow spawnBabyAnimal(EntityAgeable par1EntityAgeable) {
       return new Enchanted_Cow(this.worldObj);
       }
     }
